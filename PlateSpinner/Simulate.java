...
/**
 * Simulate class for user to interact with the spinner.
 */
public class Simulate {
	...
	/**
	 * Menu for user to pick what the spinner can do.
	 * @param in Take input from user
	 * @return the user choice as int.
	 */
